...
import net.lyx.dbframework.dao.DaoEntityException;
...
public class EntityTransmitter {
    ...
    public <T> List<T> transmitObjectsList(@NotNull ResponseStream stream, @NotNull Class<T> cls, @NotNull Composer composer, @NotNull DatabaseConnection connection) {
    ...
    private static class ObjectToEntityTemplateTransmitter {
        ...
        public void prepareEntity() {
            if (!input.isAnnotationPresent(EntityAccessible.class) && !input.isAnnotationPresent(EntityAutoPrepare.class)) {
